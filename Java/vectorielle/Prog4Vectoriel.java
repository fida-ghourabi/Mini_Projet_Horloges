...
public class Prog4Vectoriel {
    ...
    public static void main(String[] args) throws Exception {
        ...
        vectorClock[MON_ID - 1]++; int x = 5; x--; displayClock("Evenement local 2 : Soustraction");
        ...
        vectorClock[MON_ID - 1]++; int y = x + 3; displayClock("Evenement local 4 : Addition");
