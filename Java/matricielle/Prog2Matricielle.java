...
public class Prog2Matricielle {
    ...
    static class Receiver extends Thread {
        public void run() {
            try (ServerSocket serverSocket = new ServerSocket(PORT2)) {
                System.out.printf("[P%d] Serveur pret sur le port %d%n", MON_ID, PORT2);
                while (!stop.get()) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        matrixClock[MON_ID - 1][MON_ID - 1]++; int x = 7; x--; displayClock("Evenement local 2 : Decrementation");
        ...
        matrixClock[MON_ID - 1][MON_ID - 1]++; int y = x * 3; displayClock("Evenement local 4 : Multiplication");
