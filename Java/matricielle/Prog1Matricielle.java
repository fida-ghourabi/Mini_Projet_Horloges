...
public class Prog1Matricielle {
    ...
    public static void main(String[] args) throws Exception {
        ...
        matrixClock[MON_ID - 1][MON_ID - 1]++; int x = 4; x++; displayClock("Evenement local 2 : Incrementation");
        ...
        matrixClock[MON_ID - 1][MON_ID - 1]++; int y = x + 5; displayClock("Evenement local 4 : Addition");
